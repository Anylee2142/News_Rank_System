...
def init_model():
    return pickle.load(open('dataset/twitter-tfidf-mulnb.pk','rb'))
...
def news_rank_recommend(user_id, keyword, how_many):
#     model1 = init_model()
    ...
    return [crawling_list[each] for each in ranked_news]
